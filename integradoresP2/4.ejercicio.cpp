...
void pagoFactura(LinkedList<Factura> &, stack<Factura> &);

void mostrar(LinkedList<Factura> &, stack<Factura> &);


int main() {
    LinkedList<Factura> l1;
    int option;
    stack<Factura> recibo;
...
void pagoFactura(LinkedList<Factura> &l1, stack<Factura> &recibo) {
    struct Factura aux;
    int cliente = 0;
    int dia = 0;
...
void mostrar(LinkedList<Factura> &l1, stack<Factura> &recibo) {

    cout << "" << endl;
    cout << "******************RECIBO*****************" << endl;
    cout << "N cliente: " << recibo.top().nCliente << "\t";
    cout << "Pueblo: " << recibo.top().ciudad << "\t\t";
    cout << "Consumo: " << recibo.top().gb << "\t\t";
    cout << "Monto a pagar: " << recibo.top().montopagar << "\t\t";
    cout << "" << endl;
